        ...
        <c:forEach items="${orderList}" var="link">
            <tr>
                ...
                <td class="td-manage">
                    ...
                    <c:if test="${link.state == 0}">
                        <a title="去支付"
                           href="<%=request.getContextPath()%>/QueryOrderController/toApply/${link.orderId}">
                            <i class="layui-icon">&#xe63c;</i>
                        </a>
                    </c:if>
                    <c:if test="${link.state != 0}">
    ...
    <div class="page">
        <div>
            ...
            <span class="current">
                ...
                <c:if test="${i!=index}">
                    <a class="num"
                       href="<%=request.getContextPath()%>/QueryOrderController/queryOrder/${sessionScope.user.userId}?index=${i}">
                            ${i}
                    </a>
                </c:if>
            </c:forEach>
