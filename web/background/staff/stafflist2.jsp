    ...
    <div class="page">
        <div>
            <c:if test="${pageBean.index>1}">
                <a class="prev"
                   href="<%=request.getContextPath()%>/staff/workspace?index=${pageBean.index-1}&workspace=${workspace}">&lt;&lt;</a>
            </c:if>
            <c:if test="${pageBean.index<=1}">
                <a class="prev"
                   href="<%=request.getContextPath()%>/staff/workspace?index=${pageBean.index}&workspace=${workspace}">&lt;&lt;</a>
            </c:if>
            <c:forEach var="i" begin="1" end="${pageBean.pages}" step="1">
                ...
                <c:if test="${i!=pageBean.index}">
                    <a class="num" href="<%=request.getContextPath()%>/staff/workspace?index=${i}&workspace=${workspace}">
                            ${i}
                    </a>
                </c:if>
            </c:forEach>
