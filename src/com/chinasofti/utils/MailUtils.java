...
public class MailUtils {
    ...
    public static void sendMail(String toMail, String code ) throws MessagingException, GeneralSecurityException {
        ...
        message.setContent("<h1>请点击以下链接址激活注册:</br><h3>（若无法点击，请复制到浏览器中打开）</h3></h1><h3><a href='http://localhost:8080/travel/user/sendCode/" + code + "/" + toMail + "'>前往激活</a></h3>", "text/html;Charset=UTF-8");
